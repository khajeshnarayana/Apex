...
[data-testid="stSidebar"] small { color: var(--ink-soft); }
...
.nav-caption { margin: 1.3rem .45rem .35rem; }
...
[data-testid="stSidebar"] [data-testid="stRadio"] label p { color: inherit !important; }
